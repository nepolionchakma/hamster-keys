...
//   const [selectedGames, setSelectedGames] = useState([1, 2, 3, 4, 5, 6, 7, 8]);
...
//         const promoCodes = []; // Array to collect all generated promo codes

//         for (let index = 0; index < needkeys; index++) {
//           let promoCode;
//           if (index < 9 && index > 0) {
//             promoCode = await createCode(clientToken, game.promoId);
//           } else if (index < 13 && index > 8) {
//             promoCode = await createCode(clientToken, game.promoId);
//           } else if (index < 17 && index > 12) {
//             promoCode = await createCode(clientToken, game.promoId);
//           } else if (index < 21 && index > 16) {
//             promoCode = await createCode(clientToken, game.promoId);
//           } else if (index < 25 && index > 20) {
//             promoCode = await createCode(clientToken, game.promoId);
//           } else if (index < 29 && index > 24) {
//             promoCode = await createCode(clientToken, game.promoId);
...
//           updateProgress(100 / needkeys, "Generating key...");
//         }

//         // Return all collected promo codes
//         return promoCodes;
//       } catch (error: any) {
...
//           >
//             {game.name}
//             <h4 className="text-green-600">{game.number} cards</h4>
//           </button>
//         ))}
//       </div>
